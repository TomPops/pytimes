Sub CompareWorksheets(ws1 As Worksheet, ws2 As Worksheet)
    ...
    For Each cell In ws1.UsedRange
        ...
        If Not cell.Value = ws2.Range(cell.Address).Value Then
            ...
            cell.Interior.Color = vbBlue '标记不同的单元格颜色为蓝色
...
Sub CompareFiles()
    ...
    Set file1 = Workbooks.Open("C:\file1.xlsx") '替换为第一个文件的路径 file1.xlsx可更改为自己的
    Set file2 = Workbooks.Open("C:\file2.xlsx") '替换为第二个文件的路径 file2.xlsx可更改为自己的
